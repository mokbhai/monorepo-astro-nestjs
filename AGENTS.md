...
Use Node `>=22.12.0` and the pinned package manager from `packageManager` (`pnpm@11.1.3`). Do not upgrade Node, PNPM, Turbo, or framework versions unless the task is specifically about dependency maintenance.
